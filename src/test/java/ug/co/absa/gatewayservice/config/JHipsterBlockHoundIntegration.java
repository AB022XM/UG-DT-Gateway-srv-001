...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ug.co.absa.gatewayservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ug.co.absa.gatewayservice.security.DomainUserDetailsService", "createSpringSecurityUser");
